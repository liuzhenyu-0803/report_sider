#include "TemperatureResultSubGroupFrame.h"
...
TemperatureResultSubGroupFrame::TemperatureResultSubGroupFrame(QWidget *parent)
...
TemperatureResultSubGroupFrame::~TemperatureResultSubGroupFrame()
{
}

void TemperatureResultSubGroupFrame::createElements()
{
    ...
    auto dragElement_2 = new FieldDraggableElement(this);
...
QList<QWidget*> TemperatureResultSubGroupFrame::getElements()
{
    return m_elements;
}