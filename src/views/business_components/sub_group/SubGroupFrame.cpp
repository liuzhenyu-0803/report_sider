...
SubGroupFrame::SubGroupFrame(QWidget *parent)
    : QFrame(parent)
    , m_isExpanded(true)
{
    setupUI();
...
SubGroupFrame::~SubGroupFrame()
{
}

void SubGroupFrame::setupUI() {
    // 创建主布局
...
void SubGroupFrame::setGroupTitle(const QString &title) 
{
    if (m_groupLabel) {
...
void SubGroupFrame::toggleContent() 
{
...
bool SubGroupFrame::eventFilter(QObject *obj, QEvent *event) {
